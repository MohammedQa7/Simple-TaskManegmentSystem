                  ...
                  <div class="card z-index-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                          ...
                          <x-input id="name" class="form-control block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                        ...
                        <div class="mb-3">
                            <x-label for="password_confirmation" value="{{ __('Choose your company position') }} (optional)" />
                            <select class="form-control company_multi_select " name="position[]" multiple="multiple">
                                <option class="text-gray-700" value="Programmer">Programmer</option>
                                <option class="text-gray-700" value="Designer">Desginer</option>
                                <option class="text-gray-700" value="Maneger">Maneger</option>
                                <option class="text-gray-700" value="Mentor">Mentor</option>
                                <option class="text-gray-700" value="Product_Owner">Product owner</option>
                              </select>
                        </div>
                        
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="" name="task_maneger" checked="" value="1">
                            <lable class="ms-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Create account as a task maneger') }}</lable>
                          </div>
                        <p class="text-sm mt-3 mb-0 text-gray-600">{{ __('Already registered?') }} <a href="{{Route('login')}}" class="text-dark font-weight-bolder">Sign in</a></p>
                        <x-button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">
                            {{ __('Register') }}
                        </x-button>
                      </form>
