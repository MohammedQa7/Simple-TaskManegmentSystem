        ...
        <div class="card h-100">
          ...
          <div class="card-body p-3">
            ...
            <ul class="list-group">
              ...
              <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Email Verified:</strong> &nbsp; {{empty(Auth::user()->email_verified_at) ? 'Not Verified' : 'Verified'}}</li>
              <li class="list-group-item border-0 ps-0 pb-0">
                <strong class="text-dark text-sm">Social:</strong> &nbsp;
                @if (Auth::user()->facebook_link)
                <a class="btn btn-facebook btn-simple mb-0 ps-1 pe-2 py-0" href="{{Auth::user()->facebook_link}}">
                  <i class="fab fa-facebook fa-lg"></i>
                </a>
                @elseif (Auth::user()->twitter_link)
                <a class="btn btn-twitter btn-simple mb-0 ps-1 pe-2 py-0" href="javascript:;">
                  <i class="fab fa-twitter fa-lg"></i>
                </a>
                @elseif(Auth::user()->instagram_link)
